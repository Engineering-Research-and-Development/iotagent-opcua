...
function generateUpdateActions(req, contextElement, callback) {
    ...
    //GAB Era getDeviceByName
    deviceService.getDevice(contextElement.id, req.headers['fiware-service'], req.headers['fiware-servicepath'],
...
function handleQuery(req, res, next) {
    ...
    //createQueryRequests(req.body.attributes, req.body.entities, handleQueryContextRequests);
