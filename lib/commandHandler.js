...
function generateCommandExecution(apiKey, device, attribute) {
    ...
    const executions = transportSelector.createExecutionsForBinding([apiKey, device, attribute.name, serialized, contentType], 'executeCommand', device.transport || config.getConfig().defaultTransport);
