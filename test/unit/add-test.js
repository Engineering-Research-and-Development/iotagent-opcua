...
child = exec("sudo docker exec opc_ua_test_orion  ip route | grep default | cut -f 3 -d ' '", function(
    error,
    stdout,
    stderr
) {
        ...
        it('verify update of active attributes on Context Broker', function(done) {
            ...
            var temperatureRequest = {
                url:
                    ...
                    '/v2/entities/Car/attrs/Engine_Temperature',
                method: 'GET',
                headers: {
        ...
        it('verify commands execution as context provider', function(done) {
            ...
            var stopRequest = {
                url:
                    ...
                    ':' +
                    config.contextBroker.port +
                    '/v2/entities/Car/attrs/Stop?type=Car',
                method: 'PUT',
                json: json,
                headers: {
                    'fiware-service': config.service,
